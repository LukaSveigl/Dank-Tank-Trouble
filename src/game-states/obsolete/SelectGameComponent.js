...
export class SelectGameComponent {
    constructor(gl) {
        ...
        this.tankModelPath = [
            "../../common/assets/models/tanks/tank1/tank1.gltf",
            "../../common/assets/models/tanks/tank2/tank2.gltf",
            "../../common/assets/models/tanks/tank3/tank3.gltf",
        ];
    ...
    async init() {
        ...
        await this.loader.load("../../common/assets/models/floor/floor.gltf");
